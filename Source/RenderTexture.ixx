...
export namespace DirectX {
	...
	public:
		RenderTexture(ID3D12Device* pDevice, DXGI_FORMAT format, XMUINT2 size, UINT16 mipLevels = 1, const Color& clearColor = {}) noexcept : GPUResource(D3D12_RESOURCE_STATE_RENDER_TARGET), m_clearColor(clearColor) {
